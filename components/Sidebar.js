...
export default function Sidebar() {
  ...
  return (
    <div className="h-full hidden hidden sm:flex flex-col fixed xl:ml-24">
      <nav className="h-full relative xl:space-y-1.5">
        <div className="flex justify-center xl:justify-start items-center py-3 xl:p-3">
          <Image src={"/assets/x-logo.png"} width={34} height={34}/>
        </div>
      ...
      absolute xl:pl-3 flex justify-center items-center space-x-3">
