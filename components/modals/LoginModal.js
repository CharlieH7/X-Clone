...
export default function LoginModal() {
    ...
    async function handleGuestSignIn() {
      await signInWithEmailAndPassword(auth, "hope91824@gmail.com", "123456")
    }
      ...
      >
        ...
        ">
            <div className="w-[90%] mt-8 flex flex-col">
              ...
              <h1 className="text mt-4 font-bold text-4xl">Sign in to your account</h1>
              <input placeholder="Email" className="h-10 mt-8 rounded-md bg-transparent border
              border-gray-700 p-6" type={"email"}
              onChange={e => setEmail(e.target.value)}/>
              <input placeholder="Password" className="h-10 mt-8 rounded-md bg-transparent border
